...
PROFILES = {
    ...
    "native_int8_sym_unroll4_decode": {
        "mode": "realtime-int8-sym",
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "int8_sym_fused",
    ...
    "native_int8_sym_unroll4_decode_async": {
        "mode": "realtime-int8-sym",
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "int8_sym_fused",
    ...
    "native_int8_sym_unroll4_decode_bucket96": {
        "mode": "realtime-int8-sym",
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "int8_sym_fused",
    ...
    "native_int8_sym_unroll4_decode_bucket96_latency": {
        "mode": "realtime-int8-sym",
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "int8_sym_fused",
    ...
    "native_int8_sym_unroll4_decode_bucket96_remoteembed": {
        "mode": "realtime-int8-sym",
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "int8_sym_fused",
    ...
    "native_int8_sym_norepeat_unroll4_decode_bucket96_remoteembed": {
        "mode": "realtime-int8-sym-norepeat",
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "int8_sym_fused",
    ...
    "native_int8_sym_norepeat_unroll4_decode_bucket96_async": {
        "mode": "realtime-int8-sym-norepeat",
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "int8_sym_fused",
    ...
    "native_fp16_fused_rms_norepeat_bucket96": {
        "mode": "cache",
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "fp16_fused_rms",
        "codegen_unroll": "4",
        "codegen_schedule": "current",
        "codegen_decode_unroll": "auto",
        "native_pipeline": "require",
    ...
    "native_int8_sym_fused_rms_norepeat_bucket96": {
        "mode": "cache",
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "int8_sym_fused_rms",
        "codegen_unroll": "4",
        "codegen_schedule": "current",
        "codegen_decode_unroll": "auto",
        "native_pipeline": "require",
    ...
    "native_fp16_sdpa_fused_rms_norepeat_bucket96": {
        "mode": "cache",
        "cache_kernel": "sdpa",
        "cache_step": "fused",
        "graph_variant": "fp16_sdpa_fused_rms",
        "codegen_unroll": "4",
        "codegen_schedule": "current",
        "codegen_decode_unroll": "auto",
        "native_pipeline": "require",
    ...
    "native_int8_sym_sdpa_fused_rms_norepeat_bucket96": {
        "mode": "cache",
        "cache_kernel": "sdpa",
        "cache_step": "fused",
        "graph_variant": "int8_sym_sdpa_fused_rms",
        "codegen_unroll": "4",
        "codegen_schedule": "current",
        "codegen_decode_unroll": "auto",
        "native_pipeline": "require",
    ...
    "native_fp16_fused_cachedsub_norepeat_bucket96": {
        ...
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "fp16_fused_cachedsub",
        "codegen_unroll": "4",
        "codegen_schedule": "current",
        "codegen_decode_unroll": "auto",
        "native_pipeline": "require",
    ...
    "native_int8_sym_sdpa_fused_cachedsub_norepeat_bucket96": {
        "mode": "realtime-int8-sym-sdpa-fused-cachedsub-norepeat",
        "cache_kernel": "exact",
        "cache_step": "split",
        "graph_variant": "fp16",
        "codegen_unroll": "4",
    ...
    "native_fp16_fused_cachedsub_rms_norepeat_bucket96": {
        ...
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "fp16_fused_cachedsub_rms",
        "codegen_unroll": "4",
        "codegen_schedule": "current",
        "codegen_decode_unroll": "auto",
        "native_pipeline": "require",
    ...
    "native_int8_sym_fused_cachedsub_rms_norepeat_bucket96": {
        ...
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "int8_sym_fused_cachedsub_rms",
        "codegen_unroll": "4",
        "codegen_schedule": "current",
        "codegen_decode_unroll": "auto",
        "native_pipeline": "require",
    ...
    "native_int8_sym_unroll4_decode_bucket96_prompt": {
        "mode": "realtime-int8-sym",
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "int8_sym_fused",
    ...
    "native_int8_sym_unroll8_decode": {
        "mode": "realtime-int8-sym",
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "int8_sym_fused",
    ...
    "native_int8_sym_unroll12_decode": {
        "mode": "realtime-int8-sym",
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "int8_sym_fused",
...
def run_profile(name: str, args: argparse.Namespace) -> dict:
    ...
    return {
        ...
        "native_async_decode": bool(config.get("native_async_decode")),
