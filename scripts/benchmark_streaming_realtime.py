...
def run_profile(name: str, args: argparse.Namespace) -> dict:
    ...
    return {
        ...
        "host_copy_fallback_count": native_timing.get("host_copy_fallback_count"),
        "zero_copy_count": native_timing.get("zero_copy_count"),
        "callback_enqueue_ms": native_timing.get("callback_enqueue_ms"),
