...
REALTIME_BENCHMARK_PROFILE_OPTIONS = {
    ...
    "fastest_graph_fused_subcode": {
        ...
        "native_paged_kv_split_subcode": "1",
        "native_paged_kv_score_aggregation": "1",
        "native_codegen_fusion": "graph",
        "native_paged_kv_subcode_attention": "auto",
        "native_remote_embed": "0",
        "native_codegen_device": "GPU",
    },
    "fastest_graph_fused_subcode_exact": {
        "mode": "no-cache",
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "fp16",
    ...
    "fastest_graph_fused_seed_int8": {
        "mode": "no-cache",
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "int8_sym_paged_fused_seed",
        "codegen_unroll": str(FASTEST_CODEGEN_UNROLL),
        "codegen_schedule": FASTEST_CODEGEN_SCHEDULE,
        "codegen_decode_unroll": FASTEST_CODEGEN_DECODE_UNROLL,
        "preferred_cache_bucket": str(FASTEST_PREFERRED_CACHE_BUCKET),
    ...
    "graph_fused_int8_selective": {
        "mode": "no-cache",
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "int8_sym_paged_fused_seed_selective",
        "codegen_unroll": str(FASTEST_CODEGEN_UNROLL),
        "codegen_schedule": FASTEST_CODEGEN_SCHEDULE,
        "codegen_decode_unroll": FASTEST_CODEGEN_DECODE_UNROLL,
        "preferred_cache_bucket": str(FASTEST_PREFERRED_CACHE_BUCKET),
    ...
    "paged_split_int8_cachedsub": {
        ...
        "cache_kernel": "exact",
        "cache_step": "fused",
        "graph_variant": "int8_sym_paged_talker_split_cachedsub",
        "codegen_unroll": str(FASTEST_CODEGEN_UNROLL),
        "codegen_schedule": FASTEST_CODEGEN_SCHEDULE,
        "codegen_decode_unroll": FASTEST_CODEGEN_DECODE_UNROLL,
        "preferred_cache_bucket": str(FASTEST_PREFERRED_CACHE_BUCKET),
    ...
    "split_next_embed_graph": {
        ...
        "native_codegen_fusion": "split",
        "native_dynamic_quantization_group_size": "32",
        "native_subcode_next_embed_graph": "1",
        "native_codegen_device": "GPU",
    },
    "paged_split_dq64": {
        "mode": "no-cache",
    ...
    "paged_split_dq128": {
        ...
        "native_paged_kv_score_aggregation": "1",
        "native_codegen_fusion": "split",
        "native_dynamic_quantization_group_size": "128",
        "native_codegen_device": "GPU",
    },
