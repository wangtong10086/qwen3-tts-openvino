...
- Linux: `qwen3-tts-ov-server-linux-x64-0.1.3-runtime-minimal.tar.zst`
- Windows: `qwen3-tts-ov-server-windows-x64-0.1.3-runtime-minimal.zip`
- Release 页面：<https://github.com/wangtong10086/qwen3-tts-openvino/releases/tag/v0.1.3>
